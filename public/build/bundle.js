...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button.textContent = "Update your DriveStore by clicking here:";
    			attr_dev(h1, "class", "svelte-1tky8bj");
    			add_location(h1, file$3, 15, 2, 357);
    			add_location(button, file$3, 16, 2, 375);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*deployTrigger*/ ctx[1], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			h1.textContent = "Your deployment will be in production in a minute!";
    			attr_dev(h1, "class", "svelte-1tky8bj");
    			add_location(h1, file$3, 13, 2, 286);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(13:1) {#if deployTriggered}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*deployTriggered*/ ctx[0]) return create_if_block;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$3, 11, 0, 254);
    		},
    		l: function claim(nodes) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	const deployTrigger = async () => {
    		const results = fetch("https://api.vercel.com/v1/integrations/deploy/prj_LB7JXZla26aJK0aYjYzlNyU68Mas/HaEKTbdu5K", { method: "POST" });
    		console.log(results);
    	};
    	...
    	$$self.$capture_state = () => ({ deployTriggered, deployTrigger });

    	$$self.$inject_state = $$props => {
    		if ("deployTriggered" in $$props) $$invalidate(0, deployTriggered = $$props.deployTriggered);
    	};
    	...
    	return [deployTriggered, deployTrigger];
    }
